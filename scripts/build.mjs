...
for (const file of ['index.html', 'assets/logo.webp', 'assets/bancada.webp', 'assets/circuitos.svg', 'robots.txt', 'sitemap.xml', 'login.html', 'assets/auth.css']) {
  await copyFile(file, `dist/${file}`);
}
await copyFile('assets/fundo-tecnologico-claro.webp', 'dist/assets/fundo-tecnologico-claro.webp');
await copyFile('assets/fundo-tecnologico-escuro.webp', 'dist/assets/fundo-tecnologico-escuro.webp');
